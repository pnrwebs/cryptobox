...
import {getMyLeverage} from '../../store/actions';
...
const MyLeverage = props => {
  const {loading, get_MyLeverage, my_leverage} = props;
      ...
      <View style={{...styles.listItem}} ref={ref}>
        ...
        <View
          ...
          <Pressable
            ...
            onPress={() =>
              props.navigation.navigate('MyLeverageDetails', {
...
const mapDispatchToProps = dispatch => ({
  get_MyLeverage: () => dispatch(getMyLeverage()),
});
...
const mapStateToProps = state => {
  ...
  return {
    ...
    my_leverage: state.leverage.myleverage,
  };
};

export default connect(mapStateToProps, mapDispatchToProps)(MyLeverage);
