...
const WithdrawInvestInCompounding = props => {
  const {
    loading,
    submitData,
    status_success,
    status_message,
    withdrawalInvestComprest_resp,
    _status,
    ...
    <ScrollView contentContainerStyle={{flexGrow: 1}}>
      <ImageBackground
        ...
        <View style={Styles.secondContainerView}>
          <BreadcrumbBlock first={'Wallet'} second={'Invest In Compounding'} />
          ...
          <View
            ...
            <View>
              <Text style={Styles.inputBoxLabel}>Enter amount*</Text>
              <TextInput
...
const mapDispatchToProps = dispatch => ({
  ...
  submitData: (amount, walletPassword) =>
    dispatch(withdrawalInvestCompounding(amount, walletPassword)),
});
...
const mapStateToProps = state => {
  ...
  return {
    ...
    walletbalance_resp: state.auth.user,
