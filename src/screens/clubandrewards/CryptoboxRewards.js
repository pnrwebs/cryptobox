...
import {getCryptoboxRegionalRewardList} from '../../store/actions';
    ...
    <ScrollView style={styles.container} contentContainerStyle={{flexGrow: 1}}>
      <ImageBackground
        ...
        <View style={Styles.secondContainerView}>
          <BreadcrumbBlock
            first={'Club & Rewards'}
            second={'Cryptobox Regional Rewards'}
          />
          <View
            style={{
...
const mapDispatchToProps = dispatch => ({
  get_CryptoboxRewardsList: () => dispatch(getCryptoboxRegionalRewardList()),
});
...
const mapStateToProps = state => {
  ...
  return {
    ...
    cryptobox_rewards: state.rewards.cryptoboxregionalrewards,
  };
};

export default connect(mapStateToProps, mapDispatchToProps)(CryptoboxRewards);
