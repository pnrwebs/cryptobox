...
import {getMyInvestments} from '../../store/actions';
...
const MyInvestment = props => {
  const {loading, get_MyInvestments, my_investments} = props;
    ...
    <View style={styles.container}>
      <ImageBackground
        ...
        <View style={Styles.secondContainerView}>
          <BreadcrumbBlock first={'Investments'} second={'My Investments'} />
          <View
            style={{
...
const mapDispatchToProps = dispatch => ({
  get_MyInvestments: () => dispatch(getMyInvestments()),
});
...
const mapStateToProps = state => {
  ...
  return {
    ...
    my_investments: state.investments.myinvestments,
  };
};
